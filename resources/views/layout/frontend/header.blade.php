@include('layout.frontend.header_script')
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
            <a href="index.html" class="navbar-brand d-flex align-items-center text-center py-0 px-4 px-lg-5">
                {{-- <h1 class="m-0 text-primary">Hire Teacher</h1> --}}
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <a href="{{ url('/user/login/create') }}" class="btn btn-primary rounded-0 py-4 px-lg-5 d-none d-lg-block">Sign In Account<i class="fa fa-arrow-right ms-3"></i></a>
            </div>
        </nav>
        <!-- Navbar End -->
